...
FOREIGN KEY(ID_clinica) REFERENCES clínica (ID_clinica)
)

ALTER TABLE Recuperação ADD FOREIGN KEY(ID_clinica) REFERENCES clínica (ID_clinica)
ALTER TABLE avalia_avaliação ADD FOREIGN KEY(ID_clinica) REFERENCES clínica (ID_clinica)
